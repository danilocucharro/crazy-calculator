...
class Calculator_2:
    """
    - N numeros serao enviados
    - Todos os numeros serao multiplicados por 11 e elevados a potencia de 0.95
    - Por fim, é retirado o desvio padrao desses resultados e retornado o inverso desse valor (1/result)
    """
