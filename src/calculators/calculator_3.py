...
class Calculator_3:
    ...
    - caso a variancia de todos esses numeros for menor que a
    multiplicacao deles, é apresentado uma informacao de sucesso
    ao usuario
    - caso contrario, é apresentado uma informacao de falha
    """
    ...
    def __verify_results(self, variance: float, multiplication: float) -> None:
        if variance > multiplication:
            raise HttpBadRequestError("Falha no processo: Variancia maior que multiplicacao")
